...
<div id="sequence" class="seq">
    ...
    <div class="seq-screen">
      <ul class="seq-canvas">
        <li class="seq-in">
          <div class="seq-model">
            <img data-seq src="assets/img/model1.jpeg" alt="" />
          </div>

          <div class="seq-title">
            <h2 data-seq>Allons encore plus loin !!!</h2>
            <h3 data-seq></h3>
          </div>
        </li>
        ...
        <li>
          <div class="seq-model">
            <img data-seq src="assets/img/model2.jpeg" alt="" />
          </div>
        ...
        <li>
          <div class="seq-model">
            <img data-seq src="assets/img/model3.jpeg" alt="" />
          </div>
    ...
    <fieldset class="seq-nav" aria-controls="sequence" aria-label="Slider buttons">
      <button type="button" class="seq-prev" aria-label="Previous">Precedent</button>
      <button type="button" class="seq-next" aria-label="Next">Suivant</button>
    </fieldset>

<ul role="navigation" aria-label="Pagination" class="seq-pagination">
      <li><a href="#step1" rel="step1" title="1"><img src="assets/img/tn-model1.png" /></a></li>
      <li><a href="#step2" rel="step2" title="2"><img src="assets/img/tn-model2.png" /></a></li>
      <li><a href="#step3" rel="step3" title="3"><img src="assets/img/tn-model3.png" /></a></li>
    </ul>
  </div>
</section>
